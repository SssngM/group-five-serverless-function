...
def seed_data():
    ...
    event1 = Event(
        ...
        start_time=datetime(2023, 4, 15, 3, 0, 0),
        end_time=datetime(2023, 4, 15, 5, 0, 0),
        guest_max_count=6,
        guest_min_count=4,
    ...
    event2 = Event(
        ...
        restaurant_url="https://yh-beijing.com/",
        google_maps_url="https://www.google.com/maps/place/YH+-+BEIJING+%E9%A2%90%E5%92%8C%E5%8C%97%E4%BA%AC/@37.7721917,-122.4306187,15z/data=!4m6!3m5!1s0x808580a6c62a9fe5:0xb54e25c0baa0f59b!8m2!3d37.7721917!4d-122.4306187!16s%2Fg%2F11cfdbxxy",
        start_time=datetime(2023, 5, 1, 2, 0, 0),
        end_time=datetime(2023, 5, 1, 4, 0, 0),
        guest_max_count=6,
        guest_min_count=4,
        waitlist_max_count=6,
        event_type="restaurant",
    ...
    event3 = Event(
        ...
        start_time=datetime(2023, 6, 1, 1, 0, 0),
        end_time=datetime(2023, 6, 1, 3, 0, 0),
        guest_max_count=6,
        guest_min_count=4,
        waitlist_max_count=6,
        event_type="restaurant",
